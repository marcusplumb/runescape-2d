...
export const SMELT_RECIPES = [
  ...
  },
  {
    ...
    level: 50,
    xp: 110,
    output: () => ITEMS.BAR_TUNGSTEN,
    inputs: [
      { item: () => ITEMS.ORE_TUNGSTEN, qty: 1 },
      { item: () => ITEMS.ORE_COAL, qty: 3 },
    ],
  },
  {
    name: 'Obsidian Ingot',
  ...
  },
  {
    ...
    level: 80,
    xp: 200,
    output: () => ITEMS.BAR_MOONSTONE,
    inputs: [
      { item: () => ITEMS.ORE_MOONSTONE, qty: 1 },
      { item: () => ITEMS.BAR_OBSIDIAN, qty: 1 },
    ],
  },
];

export const SMELT_RECIPE_COUNT = SMELT_RECIPES.length;
export const SMELT_PH =
  FORGE_HEADER_H + SMELT_RECIPE_COUNT * FORGE_ROW_H + FORGE_PAD_BOT;
...
export const SMITH_RECIPES = {
  weapons: [
    ...
    },
    {
      ...
      level: 65,
      xp: 200,
      output: () => ITEMS.OBSIDIAN_CLEAVER,
      inputs: [{ item: () => ITEMS.BAR_OBSIDIAN, qty: 3 }],
    },
    {
      name: 'Moonstone Staff',
      level: 80,
      xp: 280,
      output: () => ITEMS.MOONSTONE_STAFF,
      inputs: [
        { item: () => ITEMS.BAR_MOONSTONE, qty: 2 },
        { item: () => ITEMS.BAR_SILVER, qty: 1 },
      ],
    },
  ],
  ...
  armor: [
    ...
    },
    {
      ...
      level: 4,
      xp: 28,
      output: () => ITEMS.BRONZE_LEGS,
      inputs: [{ item: () => ITEMS.BAR_BRONZE, qty: 2 }],
    },
    {
      name: 'Bronze Gauntlets',
      level: 2,
      xp: 12,
      output: () => ITEMS.BRONZE_GAUNTLETS,
      inputs: [{ item: () => ITEMS.BAR_BRONZE, qty: 1 }],
    },
    {
      name: 'Bronze Boots',
